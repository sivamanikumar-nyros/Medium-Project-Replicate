...
class Design extends Component {
  ...
  constructor(props){
    ...
    axios.post('http://10.90.90.117:5000/design').then(res=>{
  ...
  render() {
    ...
    var story = this.state.adminstory.map((d) => 
            ...
            <Row style={row}>
              <Col sm="4">
                <img src="design.jpg" height="100px" width="100px" alt="poster"/>
              </Col>
    ...
    <Container>
        <Row>
          ...
          <Col sm="4">
            <Card>
              <CardImg top width="100%" src="design.jpg" alt="Card image cap" />
              <CardBody>
