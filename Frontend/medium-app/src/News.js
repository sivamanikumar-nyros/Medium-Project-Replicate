...
class News extends Component {
  ...
  constructor(props){
    ...
    axios.post('http://10.90.90.117:5000/news').then(res=>{
  ...
  render() {
    ...
    var story = this.state.adminstory.map((d) => 
            ...
            <Row style={row}>
              <Col sm="4">
                <img src="news.jpeg" height="100px" width="100px" alt="poster"/>
              </Col>
    ...
    <Container>
        <Row>
          ...
          <Col sm="4">
            <Card>
              <CardImg top width="100%" src="news.jpeg" alt="Card image cap" />
              <CardBody>
