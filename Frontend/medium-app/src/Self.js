...
class Self extends Component {
  ...
  constructor(props){
    ...
    axios.post('http://10.90.90.117:5000/self').then(res=>{
  ...
  render() {
    ...
    var story = this.state.adminstory.map((d) => 
            ...
            <Row style={row}>
              <Col sm="4">
                <img src="self.jpg" height="100px" width="100px" alt="poster"/>
              </Col>
    ...
    <Container>
        <Row>
          ...
          <Col sm="4">
            <Card>
              <CardImg top width="100%" src="self.jpg" alt="Card image cap" />
              <CardBody>
